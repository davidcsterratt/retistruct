...
surrouding virutual tissue when projected back onto the spehere.

The distribution of the goodness measure is shown in
Figure~\ref{retistruct_plos:fig:summary}. The mean with 0.073, with a
...
% LocalWords:  colliculus geniculate vivo
