...
\todo{DL/IDT to check reasoning about derivation of optic axis and  provide
  data}
\todo{DCS to investigate shift of coordinates based on Drager and
  Olsen/Hubel and the Bear paper}
...
\begin{figure}[!ht]
  ...
  \caption{\textbf{Contour analysis}
    \todo{Produce contour analysis figure?}  \textbf{(A)} Contours
...
\begin{figure}[!ht]
  ...
  \caption{\textbf{Distribution of gradients.}
    \todo{Ideally we would have  fusion protein data for EphA and
      ephrin-A, and hopefully the B system too, depending on how well
      the A system works.}
    \textbf{(A)} Flat-mount retina stained for ephrin-A fusion
...
% LocalWords:  Lyngholm DL IDT hoc Hubel Diggle DCS's ger ccc
