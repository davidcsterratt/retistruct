...
\todo{DL/IDT to check reasoning about derevation of optic axis and  provide
  data}
\todo{DCS to invstigate shift of coordinates based on Drager and
...
\cite{DragHube76topo} \todo{Check my reading of Dr\"{a}ger and Hubel}.
...
% LocalWords:  colliculus geniculate vivo center RG RGC SMI ImageJ Hjorth
