##' Given a reference triangle in embedded in a 3D space, represented
##' by a 3-by-3 matrix, and arbitrary point P in cartesion
##' coordinates, represented by a 3-by-1 row vector, the intersection
##' between a line in the direction of P, from the origin and the
##' simplex can be can be written as
##'
##' rho * P = Beta * T
##'
...
##' Beta(end) = sum(Beta)
##' @title Conversion of the intersection of a line with triangle  to Barycentric coordinates
##' @param T 3-by-3 matrix representing triangle in 3D space
##' @param P Direction of line from the origin
##' @return Intersection of line with triangle expressed in
