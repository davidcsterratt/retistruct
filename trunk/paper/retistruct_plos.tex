...
We used our algorithm to reconstruct 208 retinae. The distribution of
the goodness measure is shown in
Figure~\ref{retistruct_plos:fig:summary}.
Figure~\ref{retistruct_plos:fig:examples}A shows an example of a good
reconstruction with an energy measure $\sqrt{E_\mathrm{L}}=0.040$ and
Figure~\ref{retistruct_plos:fig:examples}B an example of a bad one
with $\sqrt{E_\mathrm{L}}=0.162$.
...
\begin{figure}[!ht]
  ...
  &
  \includegraphics[width=0.24\linewidth]{C57BL6J_P4_AP_GM142-5_CONTRA-strain-lvsL}
  &
  \includegraphics[width=0.24\linewidth]{C57BL6J_P4_AP_GM142-5_CONTRA-strain}
  \\
  Aiii & Aiv & Biii & Biv  \\
  ...
  &
  \includegraphics[width=0.24\linewidth]{C57BL6J_P4_AP_GM142-5_CONTRA-flat}
  &
  \includegraphics[width=0.24\linewidth]{C57BL6J_P4_AP_GM142-5_CONTRA-polar}
  \end{tabular}
...
\begin{figure}[!ht]
  \centering
  \includegraphics{retistruct-2011-09-01-CART-CURVI-NU05-TWEAK}
  \caption{\textbf{Histogram of reconstruction errors.}  Successful
    reconstructions of 208 retinae were made and the energy
