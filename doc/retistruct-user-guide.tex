...
\newcommand{\svninfo}{Retistruct version: 0.6.0 , Date: 2019-08-16}
...
\begin{aside}{Saving reconstructions in Retistruct v0.6.0}
  The ability to save reconstructions is currently disabled in v0.6.0,
  but it is planned to enable it in v0.6.1.
\end{aside}
...
%  LocalWords:  Wulff Az El uncheck lll
