  ...
  \begin{columns}[T]
    ...
    \begin{column}{.37\linewidth}
      ...
      \begin{block}{Method}
        ...
        \includegraphics[width=\linewidth]{../paper/figures/fig1-retistruct-method}
      ...
      \begin{block}{Low \& high deformation reconstructions}
        ...
        \includegraphics[width=\linewidth]{../paper/figures/fig2-retistruct-low-high}     
        \begin{itemize}
    ...
    \begin{column}{.25\linewidth}
      ...
      \begin{block}{Validation using optic disc locations}
        ...
        \includegraphics[width=\linewidth]{../paper/figures/fig4-retistruct-ods}     
    ...
    \begin{column}{.37\linewidth}
      ...
      \begin{block}{Eye muscle insertions}
        ...
        compare this to eye muscle insertions.
                ...
                \includegraphics[width=\linewidth]{../paper/figures/fig7-retistruct-muscles}     
      \end{block}
      ...
      \begin{block}{Conversion to visuotopic coordinates}
        \includegraphics[width=\linewidth]{../paper/figures/fig6-retistruct-visuotopic.png}     
      ...
      \begin{block}{S-opsin}
        \includegraphics[width=\linewidth]{../paper/figures/fig8-retistruct-sopsin}     
